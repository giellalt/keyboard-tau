.. -*- mode: rst -*-
==========================================
 Keyboards for the Upper Tanana language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Upper Tanana language. The data and implementations
...
* http://giellatekno.uit.no/taudoc/index.html
* http://divvun.no/doc/tools/docu-tau-manual.html
...
The Upper Tanana keyboard sources can be acquired using the `Giella SVN
